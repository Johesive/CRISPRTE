...
(function(global, factory) {
    ...
    var X = {
        ...
        input: function(x, e) { return x == null ? null : [
                [+x[0], e[0][1]],
                [+x[1], e[1][1]]
            ]; },
    ...
    var Y = {
        ...
        input: function(y, e) { return y == null ? null : [
                [e[0][0], +y[0]],
                [e[1][0], +y[1]]
            ]; },
        ...
        function started(event) {
            ...
            function move(event) {
                ...
                switch (mode) {
                    ...
                    case MODE_DRAG:
                        {
                            if (signX) dx = max$2(W - w0, min$1(E - e0, dx)),
                            w1 = w0 + dx,
                            e1 = e0 + dx;
                            if (signY) dy = max$2(N - n0, min$1(S - s0, dy)),
                            n1 = n0 + dy,
                            s1 = s0 + dy;
                            break;
                        }
                    ...
                    case MODE_CENTER:
                        {
                            if (signX) w1 = max$2(W, min$1(E, w0 - dx * signX)),
                            e1 = max$2(W, min$1(E, e0 + dx * signX));
                            if (signY) n1 = max$2(N, min$1(S, n0 - dy * signY)),
    ...
    var clipAntimeridian = clip(
        ...
        clipAntimeridianInterpolate, [-pi$1, -halfPi$1]
    );
    ...
    function projectionMutator(projectAt) {
        var project,
            ...
            x0 = null,
            y0, x1, y1, postclip = identity$5, // post-clip extent
        ...
        projection.clipExtent = function(_) {
            return arguments.length ? (postclip = _ == null ? (x0 = y0 = x1 = y1 = null, identity$5) : clipRectangle(x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0], y1 = +_[1][1]), reset()) : x0 == null ? null : [
                [x0, y0],
                [x1, y1]
            ];
        };
    ...
    function albersUsa() {
        ...
        albersUsa.translate = function(_) {
            ...
            alaskaPoint = alaska
                ...
                .clipExtent([
                    [x - 0.425 * k + epsilon$1, y + 0.120 * k + epsilon$1],
